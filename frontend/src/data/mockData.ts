...
export const MOCK_TOR_CONTRACTS: TORContract[] = [
  {
    ...
    category: 'IT & Software (เทคโนโลยีและซอฟต์แวร์)',
  ...
  },
  {
    ...
    category: 'e-Bidding (ประกวดราคาอิเล็กทรอนิกส์)',
  ...
  },
  {
    ...
    category: 'General Services (จ้างเหมาบริการ)',
  ...
  },
  {
    ...
    category: 'Consulting (จ้างที่ปรึกษา)',
